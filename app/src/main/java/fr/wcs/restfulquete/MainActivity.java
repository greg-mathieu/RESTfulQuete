...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String API_KEY = "261e9aca50d78a83deb474e289ffd1af";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try
                        {
                            ...
                            {
                                JSONObject weather2 = (JSONObject) list.get(i);
                                JSONArray weather = weather2.getJSONArray("weather");

                                for (int x = 0; x < weather.length(); x++)
                                {
                                    JSONObject weatherInfos = (JSONObject) weather.get(x);
